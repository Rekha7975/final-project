...
Repository  →  SampleData (offline) + Firestore (online merge)
        ↓
Model (data classes)
See PROJECT_STRUCTURE.md for the full folder breakdown.
...
Firebase Setup
Create a Firebase project and add Android app com.karunadakala.source
Download google-services.json → place in app/
Enable Anonymous Authentication
Enable Cloud Firestore
Detailed steps: FIREBASE_SETUP.md

Google Maps API Setup
Enable Maps SDK for Android in Google Cloud Console
Create an API key (restrict to package com.karunadakala.source)
Add to local.properties:
MAPS_API_KEY=your_android_maps_key
Full guide: API_KEYS_SETUP.md
...
cd karunada-kala
Copy local.properties.example → local.properties and set sdk.dir + MAPS_API_KEY
Replace app/google-services.json with your Firebase file (optional for offline demo)
Open the project in Android Studio
File → Sync Project with Gradle Files
Run Instructions
Select a device/emulator in Android Studio
Click Run (▶️) or press Shift+F10
Grant location permission on the Map tab for “My Location”
Flow: Splash → Onboarding → Home (bottom navigation for all tabs)
...
Create a public GitHub repository and push with 5–10 meaningful commits (not a single commit)
Add screenshots to screenshots/
Configure Firebase with your real google-services.json
Add Maps API key in local.properties
Rebuild and test all navigation paths
Ensure the repo is public, cloneable, and builds without red errors
